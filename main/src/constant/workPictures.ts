import goomyWallet from "../assets/images/goomyWallet.svg";
import RbxWowPreview from "../assets/images/Rbxwow_preview.svg";
import cryptoStake from "../assets/images/LibraToken.svg";
...
import darlingWaifuLanding from "../assets/images/dw-landing-1.webp";

export const workPictures = {
  myMetaverse: {
    src: myMetaversePreview,
    alt: "MyMetaverse Parallel Planes",
  },
  darlingWaifu: {
    src: darlingWaifuLanding,
    alt: "Darling Waifu Crypto Game",
  },
  goomyWallet: {
    src: goomyWallet,
    alt: "Goomy wallet crypto",
  },
  cryptoStake: {
    src: cryptoStake,
